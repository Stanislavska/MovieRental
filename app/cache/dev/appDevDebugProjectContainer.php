...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'ProjectMoviesRentalBundle' => 'Project\\MoviesRentalBundle\\ProjectMoviesRentalBundle',
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Project/MoviesRentalBundle/Resources/views'), 'ProjectMoviesRental');
