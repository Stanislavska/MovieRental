...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'NataliaHelloBundle' => 'Natalia\\HelloBundle\\NataliaHelloBundle',
                'ShrimpsBundle' => 'Natali\\ShrimpsBundle\\ShrimpsBundle',
                'NataliaTadeuszBundle' => 'Natalia\\TadeuszBundle\\NataliaTadeuszBundle',
            ...
            'database_port' => 3306,
            'database_name' => 's179447',
            'database_user' => 's179447',
            'database_password' => 'gaaHh52L',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '10.254.94.2', 'port' => 3306, 'dbname' => 's179447', 'user' => 's179447', 'password' => 'gaaHh52L', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Natalia/TadeuszBundle/Entity'))), 'Natalia\\TadeuszBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('NataliaTadeuszBundle' => 'Natalia\\TadeuszBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_999f3c0ba938d8c56782750257ad77bbd84cab9d5b198589483842728d654851');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Natalia/HelloBundle/Resources/views'), 'NataliaHello');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Natali/ShrimpsBundle/Resources/views'), 'Shrimps');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Natalia/TadeuszBundle/Resources/views'), 'NataliaTadeusz');
